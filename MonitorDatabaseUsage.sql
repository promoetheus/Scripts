...
recmodel varchar(50),
dbsize decimal(30,2),
file_size decimal(30,2),
space_used decimal(30,2),
free_space decimal(30,2),
logfile_size decimal(30,2),
log_space_used decimal(30,2),
log_free_space decimal(30,2),
db_freespace varchar(50)
)
**/

insert into utility.dbo.DatabaseUsage(date_checked, dbname, dbstatus, recmodel, dbsize, file_size, space_used, free_space, logfile_size, log_space_used, log_free_space, db_freespace)
select 
GETDATE(), 
d.Dbname,
d.dbstatus,
