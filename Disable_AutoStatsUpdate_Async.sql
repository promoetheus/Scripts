...
-- Date: 2018-08-03
-- Set Auto Update Statistics Asynchronous Statistics OFF for User databases > 1TB
			...
			If (@AutoUpdateStats=1 And @AutoUpdateStatsAsync=1)
				Begin 
					Set @sql = 'Use master ' +	Char(10)	+
								'Alter Database ' + Quotename(@dbName) + ' Set Auto_Update_Statistics_Async Off With No_wait; '					
